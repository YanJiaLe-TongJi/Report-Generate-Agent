...
> 查看 Kimi 开放平台当前可用的多模态与编程模型，以及已下线模型的迁移提示。

> 模型定价信息参见 [产品定价](pricing/chat) 页面。

<Warning>
  `kimi-k2.5` 和 `moonshot-v1` 系列模型已于 2026 年 8 月 31 日正式下线，调用将返回 404 错误（模型不存在）。请迁移至 [kimi-k3](/docs/guide/kimi-k3-quickstart) 等最新模型。
</Warning>
...
> `kimi-k2.5` 已于 **2026 年 8 月 31 日下线**，不再维护和支持。请使用最新模型 [kimi-k3](/docs/guide/kimi-k3-quickstart) ，以获得持续支持和更强推理能力。

> `moonshot-v1` 系列模型（含 `moonshot-v1-auto` 及 `-vision-preview` 版本）已于 **2026 年 8 月 31 日下线**，不再维护和支持。请使用最新模型 [kimi-k3](/docs/guide/kimi-k3-quickstart) ，以获得持续支持和更强推理能力。
...
| `moonshot-v1-8k`                  | 已下线 |
| `moonshot-v1-32k`                 | 已下线 |
| `moonshot-v1-128k`                | 已下线 |
| `moonshot-v1-auto`                | 已下线 |
| `moonshot-v1-8k-vision-preview`   | 已下线 |
| `moonshot-v1-32k-vision-preview`  | 已下线 |
| `moonshot-v1-128k-vision-preview` | 已下线 |
